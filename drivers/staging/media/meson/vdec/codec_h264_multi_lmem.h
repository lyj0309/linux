...
enum h264_multi_lmem_param {
	H264_MULTI_PARAM_FRAME_CROP_LEFT = 0x6a,
	H264_MULTI_PARAM_FRAME_CROP_RIGHT = 0x6b,
	...
	H264_MULTI_PARAM_FRAME_CROP_TOP = 0xc0,
	H264_MULTI_PARAM_FRAME_CROP_BOTTOM = 0xc6,
